...
public class SimulationVariationIteration {
    ...
    public SimulationVariationIteration(String baseDirectory, String simulationName, String variationName, String iterationName) {
        this.baseDirectory = baseDirectory;
        this.simulationName = simulationName;
        this.variationName = variationName;
        this.iterationName = iterationName;
        this.directory = Paths.get(this.baseDirectory, this.simulationName, this.variationName, this.iterationName, "_system");
    }
    ...
    public List<SensorTelemetryRawEventIBO> loadSensorTelemetryRawEventIBOList() throws IOException {
        ...
        final List<Object> jsonObjects = objectMapper.readValue(jsonFile, new TypeReference<List<Object>>() {});
        ...
        for (final Object jsonObject : jsonObjects) {
            ...
            final Decoder decoder = DecoderFactory.get().jsonDecoder(SensorTelemetryRawEventIBO.getClassSchema(), jsonString);
            final DatumReader<SensorTelemetryRawEventIBO> reader = new SpecificDatumReader<>(SensorTelemetryRawEventIBO.class);
