...
class BackcastException(TException):
    """
    Attributes:
     - reason
...
class BackcastResponse(object):
    """
    Attributes:
     - value
     - startTimestamp: UTC Timestamp in milliseconds representing the start of the time window in which the backcasted value belongs.
     - endTimestamp: UTC Timestamp in milliseconds representing the end of the time window in which the backcasted value belongs.
