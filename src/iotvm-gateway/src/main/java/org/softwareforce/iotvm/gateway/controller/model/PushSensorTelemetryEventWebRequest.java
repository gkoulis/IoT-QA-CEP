...
/**
 * Web Request object for pushing a {@link SensorTelemetryEvent}.
 *
 * @author Dimitris Gkoulis
 */
public class PushSensorTelemetryEventWebRequest implements Serializable {
  ...
  public PushSensorTelemetryEventWebRequest() {
    this.sensorTelemetryEvent = null;
  }

  public PushSensorTelemetryEventWebRequest(SensorTelemetryEvent sensorTelemetryEvent) {
  ...
  public String toString() {
    return "PushSensorTelemetryEventWebRequest{"
