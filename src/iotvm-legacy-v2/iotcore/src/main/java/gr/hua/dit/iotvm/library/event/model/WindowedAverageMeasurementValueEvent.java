 ...
 */
public final class WindowedAverageMeasurementValueEvent extends BaseEvent implements Serializable {
    ...
    public String describe() {
        final StringBuffer sb = new StringBuffer("W.A.M.V.Event:");
        sb.append(microServiceId);
        sb.append(", ");
        sb.append(Instant.ofEpochMilli(windowStartTimeEpochMilli).toString());
        sb.append(" - ");
        sb.append(Instant.ofEpochMilli(windowEndTimeEpochMilli).toString());
        sb.append(", ").append(measurementName);
        sb.append(" (").append(measurementUnit).append(")");
        sb.append(", [");
        sb.append(sensorTelemetryMeasurementEvents.values().size());
        sb.append("|");
        sb.append(numberOfContributingNodes);
        sb.append("], ");
        sb.append(average).append(" @ ").append(Instant.ofEpochMilli(timestamp).toString());
        sb.append('}');
        return sb.toString();
    }
