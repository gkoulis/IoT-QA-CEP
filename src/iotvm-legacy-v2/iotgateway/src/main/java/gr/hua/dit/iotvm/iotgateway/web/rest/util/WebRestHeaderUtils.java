...
/**
 * Web REST Header utilities and helpers.
 *
 ...
 */
public final class WebRestHeaderUtils {

    private static final Logger log = LoggerFactory.getLogger(WebRestHeaderUtils.class);

    /* ---------------- Constructors -------------- */

    private WebRestHeaderUtils() {}
    ...
    public static HttpHeaders createAlert(String applicationName, String message, String param) {
        ...
        try {
            headers.add(
                    "X-" + applicationName + "-params", URLEncoder.encode(param, StandardCharsets.UTF_8.toString()));
